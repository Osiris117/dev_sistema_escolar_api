...
class EventosAcademicos(models.Model):
    ...
    fecha_realizacion = models.DateField(auto_now=False)
    hora_inicio = models.TimeField()
    hora_fin = models.TimeField()
    lugar = models.CharField(max_length=255)
    publico_objetivo = models.JSONField(default=list)
    programa_educativo = models.CharField(max_length=80, null=True, blank=True)
    ...
    def __str__(self):
        return f"Evento académico: {self.nombre_evento}"
